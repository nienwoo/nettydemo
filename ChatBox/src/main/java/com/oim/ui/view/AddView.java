				...
				public void backExecute(Data data) {
					if (data instanceof UserMessage) {
						...
						if (UserMessage.result_code_true.equals(message.getResultCode())) {
							UserCategory userCategory = message.getUserCategory();
			...
			DataBackActionAdapter action = new DataBackActionAdapter() {
				...
				public void backExecute(Data data) {
					if (data instanceof GroupMessage) {
						...
						if (GroupMessage.result_code_true.equals(message.getResultCode())) {
							GroupCategory groupCategory = message.getGroupCategory();
			...
			public void backExecute(Data data) {
				...
				if (data instanceof UserMessage) {
					...
					if (UserMessage.result_code_true.equals(message.getResultCode())) {
						...
						listManage.add(user, message.getUserCategoryMember());
					} else {
			...
			public void backExecute(Data data) {
				...
				if (data instanceof GroupMessage) {
					...
					if (GroupMessage.result_code_true.equals(message.getResultCode())) {
						...
						listManage.add(group, message.getGroupCategoryMember());
					} else {
