...
public class CaptureDeviceBrowser extends JPanel {
	...
	public CaptureDeviceBrowser() {
		...
		deviceComboBox = new OnlyComboBox();
		...
		okButton = new OnlyBorderButton("确定");
		...
		cancelButton = new OnlyBorderButton("取消");
	...
	/* <Integer, MediaLocator> */
	private Map deviceComboBoxMap = new HashMap();
	...
	private void populate() {
		...
		final java.util.Vector vectorDevices = CaptureDeviceManager.getDeviceList(new VideoFormat(VideoFormat.RGB));
