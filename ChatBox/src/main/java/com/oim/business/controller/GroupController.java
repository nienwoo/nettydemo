...
public class GroupController extends AbstractController {
	...
	public void setGroupCategoryWithGroupList(GroupMessage groupMessage) {
		List<GroupCategory> groupCategoryList = groupMessage.getGroupCategoryList();
		List<Group> groupList = groupMessage.getGroupList();
		List<GroupCategoryMember> groupCategoryMemberList = groupMessage.getGroupCategoryMemberList();
	...
	public void updateGroup(final GroupMessage groupMessage) {
		ListManage listManage = appContext.getManage(ListManage.class);
		listManage.updateGroup(groupMessage.getGroup());
	}
}
